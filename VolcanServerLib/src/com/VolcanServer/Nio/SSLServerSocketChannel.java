 ...
 * <code>SocketChannels</code> into <code>SSLSocketChannels</code>. The accepted
 * channels must be provided by an adapted non-secure concrete
 ...
 * It also implements <code>AdaptableChannel</code> as selectors typically don't
 * accept channel implementations from other vendors, so the selector
 * registration must be done with the adaptee channel.
 * </p>
 * 
 * @author Ilkka Priha
 * @version $Id: SSLServerSocketChannel.java,v 1.7 2009/09/28 15:08:50 cvsimp Exp $
 */
